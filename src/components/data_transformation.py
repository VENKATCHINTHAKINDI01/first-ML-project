...
class Datatransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            # Numerical pipeline: dealing with missing values and scaling
            num_pipeline = Pipeline(steps=[
                ("imputer", SimpleImputer(strategy="median")),
                ("scaler", StandardScaler())
            ])

            # Categorical pipeline: imputing, one-hot encoding, and scaling
            cat_pipeline = Pipeline(steps=[
                ("imputer", SimpleImputer(strategy="most_frequent")),
                ("one_hot_encoder", OneHotEncoder()),
                # Set with_mean=False to avoid centering sparse matrices
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            # Split input features and target features
            ...
            # Combine transformed input features with the target feature
